...
class AgentDiffViewer extends StatelessWidget {
  ...
  final AgentDiffSummary summary;
...
String _buildOverviewText(AgentDiffSummary summary) {
...
class _DiffLineRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final (background, textColor, gutterColor) = switch (line.kind) {
      AgentDiffLineKind.add => (
        colors.addBackground,
        colors.lineText,
        colors.addAccent,
      ),
      AgentDiffLineKind.remove => (
        colors.removeBackground,
        colors.lineText,
        colors.removeAccent,
      ),
      AgentDiffLineKind.header => (
        colors.hunkBackground,
        colors.hunkText,
        colors.gutterText,
      ),
      AgentDiffLineKind.meta => (
        colors.metaBackground,
        colors.textSecondary,
        colors.gutterText,
      ),
      AgentDiffLineKind.context => (
    ...
    final contentText =
        line.kind == AgentDiffLineKind.header ||
            line.kind == AgentDiffLineKind.meta
        ? line.content
...
class _DiffStatPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        formatAgentDiffStat(additions: additions, deletions: deletions),
        style: TextStyle(
