  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = context.isDarkTheme
        ? switch (mode) {
            ...
            ConversationMode.agent => Color.lerp(
              palette.surfaceSecondary,
        ...
        : switch (mode) {
            ...
            ConversationMode.agent => const Color(0xFFE7ECEF),
    ...
    final textColor = context.isDarkTheme
        ? switch (mode) {
            ...
            ConversationMode.agent => const Color(0xFFD9E0E4),
            ConversationMode.normal => Color.lerp(
              palette.textPrimary,
              palette.accentPrimary,
              0.38,
        ...
        : switch (mode) {
            ...
            ConversationMode.agent => const Color(0xFF46535B),
