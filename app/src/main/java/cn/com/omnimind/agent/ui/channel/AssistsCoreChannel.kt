...
import cn.com.omnimind.agent.manager.AssistsCoreManager
import cn.com.omnimind.agent.omniflow.OmniFlowToolChannel
...
class AssistsCoreChannel {
    ...
    private val EVENT_CHANNEL = "cn.com.omnimind.agent/AssistCoreEvent" // Flutter 事件通道
