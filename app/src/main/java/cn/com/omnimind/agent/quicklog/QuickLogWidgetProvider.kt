package cn.com.omnimind.agent.quicklog
...
import cn.com.omnimind.agent.activity.LauncherActivity
import cn.com.omnimind.agent.activity.QuickLogEntryActivity
import cn.com.omnimind.agent.activity.QuickLogWidgetSettingsActivity
...
class QuickLogWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_OPEN_SHORT_MEMORIES =
            "cn.com.omnimind.agent.quicklog.action.OPEN_SHORT_MEMORIES"
        const val ACTION_ADD_LOG = "cn.com.omnimind.agent.quicklog.action.ADD_LOG"
        const val ACTION_EDIT_LOG = "cn.com.omnimind.agent.quicklog.action.EDIT_LOG"
        const val ACTION_DELETE_LOG = "cn.com.omnimind.agent.quicklog.action.DELETE_LOG"
        const val ACTION_OPEN_SETTINGS = "cn.com.omnimind.agent.quicklog.action.OPEN_SETTINGS"
