...
import cn.com.omnimind.agent.voice.SceneVoicePlaybackManager
...
class VoicePlaybackChannel : EventChannel.StreamHandler {
    companion object {
        private const val METHOD_CHANNEL = "cn.com.omnimind.agent/VoicePlayback"
        private const val EVENT_CHANNEL = "cn.com.omnimind.agent/VoicePlaybackEvents"
    }
