    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.UPSIDE_DOWN_CAKE &&
                cn.com.omnimind.agent.util.PredictiveBackGate.isPredictiveBackEnabled(this@TerminalActivity)
            ) {
                overridePendingTransition(
                    cn.com.omnimind.agent.R.anim.activity_in,
                    cn.com.omnimind.agent.R.anim.activity_slide_out,
                )
            }
            finish()
        }
