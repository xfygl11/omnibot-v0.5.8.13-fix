...
class AgentMusicPlaybackService : Service() {
    ...
    companion object {
        private const val ACTION_PLAY = "cn.com.omnimind.agent.agent.music.PLAY"
        private const val ACTION_PAUSE = "cn.com.omnimind.agent.agent.music.PAUSE"
        private const val ACTION_RESUME = "cn.com.omnimind.agent.agent.music.RESUME"
        private const val ACTION_STOP = "cn.com.omnimind.agent.agent.music.STOP"
        private const val ACTION_SEEK = "cn.com.omnimind.agent.agent.music.SEEK"
