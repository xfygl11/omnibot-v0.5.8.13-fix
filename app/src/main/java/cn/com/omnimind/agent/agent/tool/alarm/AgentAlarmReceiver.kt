...
class AgentAlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_AGENT_ALARM_PRE_ALERT_TRIGGER =
            "cn.com.omnimind.agent.agent.ACTION_AGENT_ALARM_PRE_ALERT_TRIGGER"
        const val ACTION_AGENT_ALARM_RING_TRIGGER =
            "cn.com.omnimind.agent.agent.ACTION_AGENT_ALARM_RING_TRIGGER"
        const val ACTION_AGENT_ALARM_CLOSE =
            "cn.com.omnimind.agent.agent.ACTION_AGENT_ALARM_CLOSE"
        const val ACTION_AGENT_ALARM_SNOOZE =
            "cn.com.omnimind.agent.agent.ACTION_AGENT_ALARM_SNOOZE"
