...
interface AgentCallback {
    ...
    /**
     * Notifies that a tool call has started executing. The implementation may use
     * this to refresh per-turn activity timestamps so long-running tools do not
     * trigger a stall watchdog timeout.
     */
    suspend fun onToolActivityRefresh() = Unit
